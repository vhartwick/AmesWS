...
#from components.callbacks import select_all_download
#from components.callbacks import reset_page
from components import header, sidebar, graph_window, footer, abar
...
app.layout = html.Div([dcc.Location(id="url"),
                #header,sidebar,graph_window,footer], style={'background_color':'#252930'})
